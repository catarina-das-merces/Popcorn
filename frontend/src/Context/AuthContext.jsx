...
export const AuthProvider = ({ children }) => {
	...
	async function fetchUsers() {
		try {
			...
			const response = await fetch(
				"https://popcorn-backend-bdos.onrender.com/auth/users",
				{
					headers: {
	...
	const AdminLogin = async (email, password) => {
		try {
			const response = await fetch(
				"https://popcorn-backend-bdos.onrender.com/auth/admin",
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
	...
	const handleSubmit = async (name, email, password, role) => {
		...
		try {
			const response = await fetch(
				"https://popcorn-backend-bdos.onrender.com/auth/register",
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
	...
	async function deleteUser(userId) {
		try {
			const accessToken = localStorage.getItem("token");
			const response = await fetch(
				`https://popcorn-backend-bdos.onrender.com/auth/users/${userId}`,
				{
					method: "DELETE",
					headers: {
						"Content-Type": "application/json",
	...
	const handleLogin = async (email, password) => {
		try {
			const response = await fetch(
				"https://popcorn-backend-bdos.onrender.com/auth/login",
				{
					method: "POST",
					headers: {
						"Content-Type": "application/json",
	...
	const updateUser = async (event) => {
		...
		try {
			const accessToken = localStorage.getItem("token");
			const response = await fetch(
				`https://popcorn-backend-bdos.onrender.com/auth/users/${selectedUser._id}`,
				{
					method: "PUT",
					headers: {
						"Content-Type": "application/json",
